...
bonus_spam_text = "Получи бонусный пакет запросов, подписавшись на каналы, указанные ниже\n\nПодписался, лови запросы."
...
Я могу стать для тебя кем угодно: учёным, юмористом, консерватором, поэтом, философом, программистом или заботливым другом. Просто выбери в меню, соответствующий психотип 🧬

Вот что я умею:

1. Отвечаю на вопросы: 
   Предоставляю информацию по самым различным темам — наука, история, технологии.
...
4. Даю советы 🙂 и рекомендации: 
   Помогаю отвечать на вопросы в диалоге с конкретными людьми, консультирую по повседневным вопросам, таким как планирование, продуктивность и общение.
...
✍️ Для текстового ответа просто напиши свой вопрос.

🌅 Для создания изображения с DALL-E в меню выбери команду /dalle, далее опиши картинку, которую хочешь видеть (например — кот в сапогах).

🔄 Чтобы очистить контекст диалога, используй команду /reset — я забуду всё, о чем мы говорили.
